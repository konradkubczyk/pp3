public class Room {
    ...
    public static void displayStatusInOneRow(Room room) {
        System.out.println("Room " + room.number + " has " + room.beds + " bed(s) and is currenty " + (room.occupied ? "occupied" +
        " by " + room.guestName + "." : "vacant."));
    }
    ...
    public static void main(String[] args) {
        ...
        Room.displayStatusInOneRow(rooms[0]);
        System.out.println("\n");
